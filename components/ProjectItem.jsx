...
const ProjectItem = ({ title, image, porjectUrl, tech }) => {
    return (
        <div className="relative flex items-center justify-center w-full h-auto p-3 bg-green-bright/20 rounded-xl group hover:bg-gradient-to-br from-green-bright to-green-500">
            <Image
